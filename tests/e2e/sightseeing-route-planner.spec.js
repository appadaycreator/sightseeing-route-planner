...
const SVC_URL = "https://appadaycreator.com/sightseeing-route-planner/";
const SVC_NAME = "観光ルート最適化ツール";

test.describe("観光ルート最適化ツール - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("sightseeing-route-planner");
